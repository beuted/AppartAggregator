...
export class ConfigService {
    ...
    private _searchUrls = {
        // WARNING: new SeLoger urls endoing with "qsVersion=1.0" will be rejected (you need to check change the header of the request probably)
        seLoger: 'https://www.seloger.com/list.htm?ci=750103,750110,750111,750112,750120&idtt=1&idtypebien=1,2&naturebien=1&nb_pieces=2&pxmax=1600&surfacemin=50&tri=initial',
